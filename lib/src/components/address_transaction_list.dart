...
Future<List<Transaction>> fetchTxs(String address) async {
  final response = await http.Client()
      .get(Uri.parse('https://bcschain.info/api/address/$address/basic-txs'));
    ...
    return FutureBuilder<List<Transaction>>(
      ...
      builder: (context, snapshot) {
        ...
        return snapshot.hasData
          ...
          : Center(child: CircularProgressIndicator(color: Color(0xffbb9f89)));
      },
    );
  }
}
            ...
            children: [
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Text((double.parse(txs[index].amount) / CONSTANTS.BCS_DECIMALS).toStringAsFixed(7) + ' BCS',
                    textAlign: TextAlign.right,
                    style: TextStyle(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Divider(),
          _tile(context, '${formatAmount(tx.amount)} BCS', AppLocalizations.of(context)!.amount, Icons.payments, null),
          Divider(),
        ]
      )
    );
...
String formatAmount(String amount) {
  ...
  return (value / CONSTANTS.BCS_DECIMALS).toStringAsFixed(7);
}
...
ListTile _tile(BuildContext context, String title, String subtitle, IconData icon, String? url) => ListTile(
  ...
  onTap: () {
    if (url != null) _launchURL('https://bcschain.info/$url');
  },
  onLongPress: () {
