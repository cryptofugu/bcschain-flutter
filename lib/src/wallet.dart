...
class WalletState extends State<Wallet> {
  ...
  Future<BitcoinLibrary.Wallet> _loadWallet() async {
    ...
    wallet = BitcoinLibrary.Wallet.fromWIF(configurationService.getBCSWIF(), CONSTANTS.bcsNetwork);
    return wallet;
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<BitcoinLibrary.Wallet>(
      ...
      builder: (context, snapshot) {
          ...
          return Container(
            child: DefaultTabController(
              ...
              child: Scaffold(
                appBar: AppBar(
                  bottom: TabBar(
                    indicatorColor: Color(0xfffaede3),
                    labelColor: Color(0xfffaede3),
                    unselectedLabelColor: Color(0xff27262e),
                    tabs: [
                  ...
                  title: Text(AppLocalizations.of(context)!.bcsWallet),
                ),
                body: TabBarView(
                  children: [
                    Column(
        ...
        return Center(child: CircularProgressIndicator(color: Color(0xffbb9f89)));
      }
    );
  }
}