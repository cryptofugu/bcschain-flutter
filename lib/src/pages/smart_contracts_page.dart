...
class SmartContractPageState extends State<SmartContractPage> {
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: addressFocusNode.hasFocus ? TextStyle(color:Color(0xffbb9f89)) : TextStyle(color:Colors.grey),
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: abiFocusNode.hasFocus ? TextStyle(color: Color(0xffbb9f89)) : TextStyle(color: Colors.grey),
                    hoverColor: Color(0xffbb9f89),
                    focusedBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                        color: Color(0xffbb9f89),
                        ...
                        for(int i=0; i<snapshot.data!.length; i++)
                          Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: inputFocusNodes[i].hasFocus ? TextStyle(color:Color(0xffbb9f89)) : TextStyle(color:Colors.grey),
                                hoverColor: Color(0xffbb9f89),
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Color(0xffbb9f89),
                          ...
                          (abi[dropdownItems.indexOf(dropdownValue)].stateMutability == 'payable') ? Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                border: OutlineInputBorder(),
                                labelText: AppLocalizations.of(context)!.value_bcs,
                                labelStyle: valueFocusNode.hasFocus ? TextStyle(color:Color(0xffbb9f89)) : TextStyle(color:Colors.grey),
                                hoverColor: Color(0xffbb9f89),
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Color(0xffbb9f89),
                          ...
                          (abi[dropdownItems.indexOf(dropdownValue)].stateMutability != 'view') ? Text(AppLocalizations.of(context)!.fee_sat) : Text(''),
                          ...
                          (abi[dropdownItems.indexOf(dropdownValue)].stateMutability != 'view') ? Text(AppLocalizations.of(context)!.gasPrice_sat_per_gas) : Text(''),
                          (abi[dropdownItems.indexOf(dropdownValue)].stateMutability != 'view') ? Slider(
                          ...
                          ElevatedButton(
                            ...
                            style: ButtonStyle(
                              backgroundColor: MaterialStateProperty.all(Color(0xffbb9f89))
                            )
                          )
                      ],
                    ); 
  ...
  callViewFunction() async {
    ...
    Wallet wallet =  Wallet.fromWIF(configurationService.getBCSWIF(), CONSTANTS.bcsNetwork);
    ...
    try {
      var uriResponse = await client.get(Uri.parse('https://bcschain.info/api/contract/${addressController.text}/call?data=$data&sender=$sender'));
  ...
  sendToContract() async {
    ...
    if (inputs.isNotEmpty) {
      ...
      txb.addOutput(contract, (double.parse(valueController.text) * CONSTANTS.BCS_DECIMALS).toInt());
    ...
    while (typeList.isNotEmpty) {
      for (int i = 0; i < typeList.length; i++) {
        if (typeList[i].startsWith('uint') || typeList[i].startsWith('int')) {
          ...
          var address;
          if (inputControllers[i + deletedItemsCounter].text.startsWith('B') && inputControllers[i + deletedItemsCounter].text.length == 34)
